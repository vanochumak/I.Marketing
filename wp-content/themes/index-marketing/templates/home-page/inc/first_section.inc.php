...
?>
    <section
            class="s-top <?php echo $first_section['add_background_section'] == 'true' ? 'add-background-section' : '' ?>"
            style="background-image: url('<?php echo $first_section['background_image']['url']; ?>')">
        <div class="container-fluid">
            <div class="justify-content-center">
                <div class="row">
<!--                    <div class="col-sm-10 col-lg-5 col-xl-5 s-top-center">-->
                    <div class="s-top-center">
                        <?php
                        echo $first_section['title'] ? '<h1>' . $first_section['title'] . '</h1>' : '';
                        echo $first_section['sub_title'] ? '<h2>' . $first_section['sub_title'] . '</h2>' : '';
